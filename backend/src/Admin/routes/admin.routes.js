...
adminRoutes.post('/students/import/preview', upload.single('file'), adminController.importStudentsPreviewController);
adminRoutes.post('/students/import/confirm', adminController.confirmImportStudentsController);

// =========================================================
// OFFICERS
// =========================================================
adminRoutes.post('/officers', adminController.createOfficerController);
adminRoutes.post('/officers/import/preview', upload.single('file'), adminController.importOfficersPreviewController);
adminRoutes.post('/officers/import/confirm', adminController.confirmImportOfficersController);

// =========================================================
// MANAGERS
// =========================================================
adminRoutes.post('/managers', adminController.createManagerController);
adminRoutes.post('/managers/import/preview', upload.single('file'), adminController.importManagersPreviewController);
adminRoutes.post('/managers/import/confirm', adminController.confirmImportManagersController);
