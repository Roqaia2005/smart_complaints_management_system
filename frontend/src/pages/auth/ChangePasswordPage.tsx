    ...
    <AuthCard>
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          You're using a temporary password. Set a new one to secure your
          account.
        </p>
      </div>
      ...
      {!done ? (
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="current-pass" className="text-[0.8rem] font-medium">
              Current password
            </label>
            <PasswordInput
              id="current-pass"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="new-pass" className="text-[0.8rem] font-medium">
              New password
            </label>
            <PasswordInput
              id="new-pass"
        ...
        <div className="flex flex-col items-center text-center gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <h2 className="text-[1.3rem] font-bold tracking-tight">
              Password updated
            </h2>
            <p className="text-sm text-muted-foreground mt-1 max-w-[300px]">
              Your password has been changed successfully. Sign in again with
              your new password.
            </p>
          </div>
          <SuccessAlert>
